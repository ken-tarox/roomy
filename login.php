...
<div class="container pb-5">
  <form action="" method="post" class="form-signin mt-5">
    ...
    <dl>
      <dd>
        <input type="email" name="email" size="35" maxlength="255" value="<?php print(htmlspecialchars($email, ENT_QUOTES)); ?>" class="form-control" placeholder="Email" required autofocus/>
